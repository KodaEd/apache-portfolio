...
export default function Modal({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div 
        className="relative bg-white w-full max-w-md mx-4 max-h-[90vh] flex flex-col shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
  ...
  return (
    <button
      ...
      className={`
        ...
        active:bg-gray-300
        ${variant === 'primary' ? 'bg-black text-white hover:bg-gray-900 active:bg-gray-800' : ''}
      `}
      style={{
